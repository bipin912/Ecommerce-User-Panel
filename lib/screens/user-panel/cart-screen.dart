                              ...
                              child: ListTile(
                                ...
                                subtitle: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        if (cartModel.productQuantity > 1 && cartModel.isSale == true ) {
                                          await FirebaseFirestore.instance
                                              .collection('cart')
                                              .doc(user!.uid)
                                              .collection('cartOrders')
                                        ...
                                        if (cartModel.productQuantity > 1 && cartModel.isSale == false ) {
                                          await FirebaseFirestore.instance
                                              .collection('cart')
                                              .doc(user!.uid)
                                              .collection('cartOrders')
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        if (cartModel.productQuantity > 0 && cartModel.isSale == false) {
                                          await FirebaseFirestore.instance
                                              .collection('cart')
                                              .doc(user!.uid)
                                              .collection('cartOrders')
                                        ...
                                        if (cartModel.productQuantity > 0 && cartModel.isSale == true) {
                                          await FirebaseFirestore.instance
                                              .collection('cart')
                                              .doc(user!.uid)
                                              .collection('cartOrders')
